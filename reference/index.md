...
- [`get_encceja()`](https://sidneybissoli.github.io/educabR/reference/get_encceja.md)
  : Get ENCCEJA (Exame Nacional para Certificação de Competências de
  Jovens e Adultos) data
...
Functions for School Census data
