...
from INEP (Instituto Nacional de Estudos e Pesquisas Educacionais Anisio Teixeira).
With simple functions, you can download and process data from:
...
For detailed information about variables, see INEP's official documentation:
